...
class TestStaffUpdateTrekSlots(unittest.TestCase):
    def setUp(self):
    ...
    def test_staff_can_update_assigned_trek_slots(self):
        trek = Trek(
        ...
        response = self.client.put(
            f"/api/staff/treks/{trek.id}/slots",
            json={"available_slots": 4},
        ...
        self.assertEqual(payload["data"]["available_slots"], 4)

    def test_staff_cannot_reduce_slots_below_booked_count(self):
        trek = Trek(
            trek_name="Assigned Trek",
            location="Nepal",
            description="Assigned",
        ...
        self.assertIn("Available slots cannot be less than booked participants", payload["message"])
