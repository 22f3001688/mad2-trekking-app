...
import AdminUsersSummary from '../views/AdminUsersSummary.vue'
...
const routes = [
  ...
  { path: '/admin/users', name: 'AdminUsersSummary', component: AdminUsersSummary, meta: { requiresAuth: true, role: 'admin' } },
